...
> Исторический документ. Описанный здесь статический сайт (`site/index.html`, `site/styles.css`, `site/experience.*`, `site/demo-data.js`, корневой `index.html`) удалён в версиях 1.2.0 и 1.2.1: сервер его не отдавал. Текст сохранён как запись о дизайн-решении, а не как описание текущего кода.
